...
+ [Trying to create a main menu](https://forums.unrealengine.com/showthread.php?59487-Trying-to-create-a-main-menu) ![Forum Epic](https://img.shields.io/badge/forum-epic-lightgrey.svg) ![Blueprint solution](https://img.shields.io/badge/blueprint-solution-blue.svg)

## Interface

+ [How to Create a Custom Cursor](https://www.youtube.com/watch?v=_JI6MkWiI94) ![8 minutes YouTube](https://img.shields.io/badge/youtube-8m-red.svg) ![Blueprint solution](https://img.shields.io/badge/blueprint-solution-blue.svg)

+ [How can i add buttons dynamically on my UMG Widget?](https://answers.unrealengine.com/questions/91033/how-can-i-add-buttons-dynamically-on-my-umg-widget.html) ![UE4 AnswerHub](https://img.shields.io/badge/answerhub-epic-lightgrey.svg) ![Blueprint solution](https://img.shields.io/badge/blueprint-solution-blue.svg)
...
+ [A plugin for Unreal Engine 4 that lets you configure AndroidManifest](https://github.com/gameDNAstudio/AndroidManifestConfigurator) ![Engine Plugin with source code](https://img.shields.io/badge/plugin_src-solution-orange.svg)

## AppleTV

+ [Running Unreal Games on real devices with Xcode 7 without iOS Dev. subscription](https://forums.unrealengine.com/showthread.php?77234-You-can-legally-run-and-test-your-Unreal-games-on-devices-with-Xcode-7-without-iOS-Dev-subscription) ![Forum Epic](https://img.shields.io/badge/forum-epic-lightgrey.svg)
...
+ [Behavior Trees](https://docs.unrealengine.com/latest/INT/Engine/AI/BehaviorTrees/index.html) ![Documentation Epic](https://img.shields.io/badge/documentation-epic-lightgrey.svg)

+ [Blueprint Behavior Tree Tutorial](https://wiki.unrealengine.com/Blueprint_Behavior_Tree_Tutorial) ![Wiki Epic](https://img.shields.io/badge/wiki-epic-lightgrey.svg)
...
+ [Steam Greenlight](https://steamcommunity.com/greenlight/) ![Official Steam](https://img.shields.io/badge/official-steam-000000.svg)
...
+ [STEAMWORKS](http://www.steampowered.com/steamworks/) ![Official Steam](https://img.shields.io/badge/official-steam-000000.svg)

API of Steam to be integrated into the game for getting full access of the options of the steam platform.

+ [Using the Steam SDK During Development](https://wiki.unrealengine.com/Steam,_Using_the_Steam_SDK_During_Development) ![Wiki Epic](https://img.shields.io/badge/wiki-epic-lightgrey.svg)
...
+ [Learning Templates Arcade Games](https://forums.unrealengine.com/showthread.php?60150-Learning-Templates-Blueprint-Power) ![Forum Epic](https://img.shields.io/badge/forum-epic-lightgrey.svg)
